<div class="mx-auto max-w-2xl">
    ...
    @if ($categoryName)
        <div class="mb-6 flex items-center gap-2">
            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-road-yellow/30 bg-road-yellow/8 text-road-yellow text-xs font-medium">
            ...
            <span class="text-xs text-zinc-500">Category test</span>
        </div>
    @endif
